...
<html lang="pt-BR">
	...
	<title>Acessar &lsaquo; teste2 &#8212; WordPress</title>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Ir para teste2</a>		</p>
			</div>
...
var _wpUtilSettings = {"ajax":{"url":"\/teste\/wp-admin\/admin-ajax.php"}};
</script>
<script src="./wp-includes/js/wp-util.min.js?ver=5.9.1" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"386f6116bd"};
</script>
